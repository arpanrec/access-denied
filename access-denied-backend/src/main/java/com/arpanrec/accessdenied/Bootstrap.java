...
import com.arpanrec.accessdenied.exceptions.GPGException;
import com.arpanrec.accessdenied.services.EncryptionService;
import com.arpanrec.accessdenied.services.RootPasswordService;
import com.arpanrec.accessdenied.utils.FileUtils;
...
public class Bootstrap implements CommandLineRunner {
    ...
    private final AccessDeniedConfigurations configurations;
    ...
    public Bootstrap(
            ...
            @Autowired AccessDeniedConfigurations configurations,
    ...
    private void loadUnlockKeys(String unlockKeyFromConfig) {
        ...
        try {
            unlockKeyFromConfig = new String(
                    Base64.getDecoder().decode(FileUtils.INSTANCE.fileOrString(unlockKeyFromConfig)),
        ...
        try {
            EncryptionService.UnlockKey unlockKey = new ObjectMapper()
                    .readValue(FileUtils.INSTANCE.fileOrString(unlockKeyFromConfig), EncryptionService.UnlockKey.class);
