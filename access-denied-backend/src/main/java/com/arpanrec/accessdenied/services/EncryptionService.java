...
import com.arpanrec.accessdenied.encryption.GnuPG;
...
public class EncryptionService {
    ...
    private final Map<Namespace, Pair<String, GnuPG>> encryptor = new HashMap<>();
    ...
    public static class InitializeDetails {
        ...
        String namespace = AccessDeniedConstants.NAMESPACE_DEFAULT;
    }
}
